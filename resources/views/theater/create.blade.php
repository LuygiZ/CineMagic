                ...
                <form method="POST" action="{{ route('theater.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex flex-wrap space-x-8">
                        <div class="grow mt-6 space-y-4">
                            ...
                            <x-field.input name="rows" label="Row number" type="number" value="{{ old('rows') }}" class="block w-full"/>
                            <x-field.input name="seats_per_row" label="Number of seats per row" type="number" value="{{ old('seats_per_row') }}" class="block w-full"/>
                        </div>
